...
public class ProfileController {
  ...
  public ResponseEntity<String> update(@Validated @PathVariable Long profileId,
  ...
  public ResponseEntity<ProfileResponseDto> showProfile(@PathVariable Long profileId,
