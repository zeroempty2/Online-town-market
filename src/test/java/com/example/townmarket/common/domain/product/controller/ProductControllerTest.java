...
class ProductControllerTest {
  ...
  void getProducts() throws Exception {
    ...
    Page<PagingProductResponse> productResponseDtos = new PageImpl<>(
        Collections.singletonList(PAGING_PRODUCT_RESPONSE), pageable, 1);
    ...
    resultActions.andDo(document("productController/getProducts",
        ...
        responseFields(
            fieldWithPath("content[].productName").type(JsonFieldType.STRING).description("유저 아이디"),
            fieldWithPath("content[].productPrice").type(JsonFieldType.STRING).description("지역"),
